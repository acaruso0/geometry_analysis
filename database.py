...
def loaddb():    
    with open('periodic_table.pickle', 'rb') as handle:
        periodic_table = pickle.load(handle)
    return periodic_table

def get_name(obj, periodic_table):
...
if __name__ == "__main__":
    ...
    with open('periodic_table.pickle', 'wb') as handle:
        pickle.dump(periodic_table, handle, protocol=pickle.HIGHEST_PROTOCOL)
